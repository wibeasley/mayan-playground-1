...
read_chunk("./cartography-timeline/cartography-timeline.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r graph-continuous, echo=echo_chunks, message=message_chunks}
```
