...
6700 BCE,"map of Catal Hyuk - earliest known map",5
3000 BCE,"Babylonian clay tablets including map of present day Iraq",10
3000 BCE,"first map of the moon",15
600 BCE,"Pythagoas determines earth is a sphere",20
200 BCE,"Eratosthenes determines circumpherence of the earth",-5
150 BCE,"Hipparchus creates early system of latitude based on the sun",-10
150 CE,"Ptolemy creates world map with coordinates for 8,000 locations",-15
476 CE,"Roman Empire collapses, scientific cartography halts in Europe",-20
830 CE,"Al-Khwarizmi produces wowrld map partly based on Ptolemy\'s work",-20
1030 CE,"Al-Biruni develops triangulation",20
1375 CE,"Abraham Cresques produces world map using portolan maps",-15
...
1884 CE,"International Meridian Conference chooses Greenwich as prime meridian",-10
...
ggplot(ds, aes(x=date, y=position_y, label=milestone))  +
  geom_point()
